<!--
 * @Author: Kenny
 * @Date: 2022-06-16 16:37:05
 * @LastEditors: Kenny
 * @LastEditTime: 2022-06-17 17:45:24
 * @FilePath: \yiya-straight-pc\src\components\page-echarts\src\bar-echarts.vue
-->
    ...
    yAxis: [
      {
        ...
        interval: 50,
        axisLabel: {
          color: activeThemeName.value === "dark" ? "#fff" : "#666"
        },
        //name的样式设计
        nameTextStyle: {
          align: "left",
...
<template>
  <div class="bar-echarts">
    <baseEcharts :options="option" mark="businessBar" />
  </div>
</template>
