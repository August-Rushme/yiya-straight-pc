...
<template>
  <div class="wrapper">
    <input
      ...
      name="checkbox"
      class="switch"
      :checked="activeThemeName === 'normal'"
      @click="handleSetTheme(activeThemeName === 'dark' ? 'normal' : 'dark')"
    />
  </div>
</template>
...
.switch:after {
  ...
  box-shadow: inset 3px -3px 2px rgba(53, 53, 53, 0.3);
}
...
@keyframes sun {
  ...
  100% {
    ...
    background-color: #f5daaa;
    box-shadow: 0px 0px 5px #f5deb4, 0px 0px 10px #f5deb4, 0px 0px 15px #f5deb4, inset 0px 0px 2px #efd3a3;
    filter: blur(1px);
  }
}
...
.switch:before {
  ...
  filter: blur(1px);
  background-color: #f5daaa;
  box-shadow: 0px 0px 5px #f5deb4, 0px 0px 10px #f5deb4, 0px 0px 155px #f5deb4, inset 0px 0px 1px #efd3a3;
  transform-origin: 27px 5px;
